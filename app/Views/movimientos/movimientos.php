                ...
                <div class="card card-primary card-outline card-tabs">
                    <div class="card-header p-0 pt-1 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-three-home-tab" data-bs-toggle="tab" href="#tabentrada" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">Entrada</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-three-profile-tab" data-bs-toggle="tab" href="#tabsalida" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Salida</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control" id="txtdestinatario" name="txtdestinatario" placeholder="Destinatarios" disabled>
